            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                <form action="{{ route('discounts.update', $discount->id) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" id="name" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('name', $discount->name) }}" required>
                        @error('name')
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="code" id="code" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('code', $discount->code) }}">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="type" id="type" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                            ...
                            <option value="buy_x_get_y" {{ old('type', $discount->type) == 'buy_x_get_y' ? 'selected' : '' }}>Beli X Gratis Y</option>
                        </select>
                        @error('type')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" step="0.01" name="value" id="value" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('value', $discount->value) }}" required>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="min_purchase" id="min_purchase" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('min_purchase', $discount->min_purchase) }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="max_discount" id="max_discount" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('max_discount', $discount->max_discount) }}">
                    ...
                    <div class="mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" name="start_date" id="start_date" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('start_date', $discount->start_date ? $discount->start_date->format('Y-m-d') : '') }}">
                        ...
                        <div>
                            ...
                            <input type="date" name="end_date" id="end_date" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('end_date', $discount->end_date ? $discount->end_date->format('Y-m-d') : '') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="applies_to" id="applies_to" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                            <option value="all" {{ old('applies_to', $discount->applies_to) == 'all' ? 'selected' : '' }}>Semua Produk</option>
                            <option value="category" {{ old('applies_to', $discount->applies_to) == 'category' ? 'selected' : '' }}>Kategori Tertentu</option>
                    ...
                    <div id="category_selection" class="mb-6 {{ old('applies_to', $discount->applies_to) == 'category' ? '' : 'hidden' }}">
                    ...
                    <div id="product_selection" class="mb-6 {{ old('applies_to', $discount->applies_to) == 'product' ? '' : 'hidden' }}">
                        ...
                        <select name="product_id" id="product_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                            ...
                            @foreach($products as $product)
                                <option value="{{ $product->id }}" {{ old('product_id', $discount->product_id) == $product->id ? 'selected' : '' }}>{{ $product->nama_barang }} - {{ $product->kode_barang }}</option>
                            @endforeach
                        </select>
                        @error('product_id')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div class="mb-6">
                        <div class="flex items-center">
                            <input type="checkbox" name="is_active" id="is_active" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" value="1" {{ old('is_active', $discount->is_active) ? 'checked' : '' }}>
